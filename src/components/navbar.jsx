...
function Navbar() {
    ...
    return (
        <div className="w-full  px-4 flex h-18 items-center justify-between bg-white">
            ...
            <div className="inputGroup group relative">
                ...
                <input onClick={() => navigate("/")} value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} class="focus:ring-2 focus:ring-blue-500 focus:outline-none appearance-none w-[20rem] text-sm leading-6 text-slate-900 placeholder-slate-400 rounded-md py-2 pl-10 ring-1 ring-slate-200 shadow-sm" type="text" aria-label="Search Movies" placeholder="Search Movies..."></input>
            </div>
